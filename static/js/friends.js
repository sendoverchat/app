...
socketFriends.onmessage = function(message) {
    ...
    if(data.name == "errorFriendRequest"){
    ...
    }else if(data.name == "getFriendRequest"){
        ...
        <svg class="svg-accept-request-btn" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
        ...
        if(div_result.innerHTML.includes("div-nothing-request")){
            ...
            div_result.innerHTML = div_result.innerHTML + div;
        }

    }else if(data.name == "successFriendRequest"){
